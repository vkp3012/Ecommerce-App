        ...
        <Container class1 = "store-wrapper home-wrapper-2 py-5">
            <div className='row'>
                <div className='col-3'>
                    ...
                    <div className='filter-card mb-3'>
                        <h3 className='fiter-title'>Product Tags</h3>
                        <div>
                    ...
                    <div className='filter-card mb-3'>
                        ...
                        <div>
                            <div className='random-product mb-3 d-flex'>
                                ...
                                <div className='w-50'>
                                    <h5>Kids headphones bulk 10 pack multi colored fro students</h5>
                                    <ReactStars 
                                        count = { 5}
                                        size = {24}
                                        value = {4}
                        ...
                        <div className='d-flex justify-content-between align-items-cneter'>
                            <div className='d-flex align-items-center gap-10'>
                                ...
                                >
                                    ...
                                    <option className='title-descending'>Alphabetically, A-Z</option>
